...
const LoginForm: React.FC = () => {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    // Capture os valores de entrada do formulário
          ...
          <div className="md:max-w-md w-full px-4 py-4">
            <form onSubmit={handleSubmit}>
              <div className="mb-12">
                ...
                <p className="text-sm mt-4 text-gray-800">Don&#39;t have an account? <a href="/auth/register"
                                                                                        className="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Register here</a></p>
              </div>
              ...
              <div className="flex flex-wrap items-center justify-between gap-4 mt-6">
                ...
                <div>
                  <a href="/auth/forgot-password" className="text-blue-600 font-semibold text-sm hover:underline">
                    Forgot Password?
                  </a>
                </div>
              </div>
